...
const Header = () => {
	...
	useEffect(() => {
		console.log(photo);
	}, [photo]); //this second useEffect will fire on the initial component render and tracks if there is change
	//to the photo
	...
	return (
		<section className='photo-container'>
			<header className='header'>
				...
				<p className='page-title-info'>
					Want a glimpse into outerspace? Check out the Astronomy Photo of the
					Day brought to you by NASA.
					<br />
					Your daily reminder that we are actually just spinning in outerspace
					on a pale blue dot and anything is possible! <br />
				</p>
				...
				<div className='image'>
					...
					<div className='photo-description-container'>
						...
						<p className='photo-title-info'>
							<strong>Title:</strong> {photo.title}
						</p>
						<p className='copyright-title-info'>
