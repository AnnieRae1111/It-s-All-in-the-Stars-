    ...
    useEffect(() => {
        signs.forEach((sign) => {
        fetchHoroscopes(day, sign.name, sign.image); //mapping over signs array to return image and sign name.//looping : on each iteration we are calling to the function to add to our array
        });
    }, [day]); 
